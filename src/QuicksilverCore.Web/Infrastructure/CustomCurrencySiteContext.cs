...
public class CustomCurrencySiteContext : DefaultSiteContext
{
    ...
    public CustomCurrencySiteContext(ICurrencyService currencyService, ICurrentMarket currentMarket, LanguageService languageService, IWebHostEnvironment webHostEnvironment, IHttpContextAccessor httpContextAccessor)
        : base(currentMarket, webHostEnvironment, httpContextAccessor)
    {
